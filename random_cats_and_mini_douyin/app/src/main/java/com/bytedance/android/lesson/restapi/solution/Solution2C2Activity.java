...
public class Solution2C2Activity extends AppCompatActivity {
    ...
    private void postVideo() {
        ...
        final Call<PostVideoResponse> postCall = Pservice.createVideo("16061121","wxxxzhang",
        ...
        postCall.enqueue(new Callback<PostVideoResponse>() {
            ...
            public void onResponse(Call<PostVideoResponse> call, Response<PostVideoResponse> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    Toast.makeText(Solution2C2Activity.this,R.string.success_try_refresh,Toast.LENGTH_LONG);
            ...
            mRv.getAdapter().notifyDataSetChanged();*/
                    ...
                    Log.i("success",postResponse.getUrl());
                    Toast.makeText(Solution2C2Activity.this, "Failed!", Toast.LENGTH_LONG);
                    mBtn.setEnabled(true);
                    mBtn.setText(R.string.select_an_image);
                }
            }
